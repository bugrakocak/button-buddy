...
const styleByButtonType = (button, buttonStyle, primaryColor, secondarycolor) => {
  ...
  if (buttonStyle === 'modern') {
    ...
    button.effects = [
      {
        type: 'DROP_SHADOW',
        color: { ...primaryColorAsRgbUnit, a: 0.2 },
        offset: { x: 0, y: 4 },
        radius: 12,
        visible: true,
        blendMode: 'NORMAL',
  ...
  if (buttonStyle === 'flatShadow') {
    ...
    button.effects = [
      {
        type: 'DROP_SHADOW',
        color: { ...primaryColorAsRgbUnit, b: primaryColorAsRgbUnit.b * 0.8, a: 1 },
        offset: { x: 0, y: 4 },
        radius: 0,
        visible: true,
        blendMode: 'NORMAL',
  ...
  if (buttonStyle === 'glossy') {
    ...
    button.effects = [
      {
        type: 'INNER_SHADOW',
        color: { r: 0 / 255, g: 0 / 255, b: 0 / 255, a: 0.2 },
        offset: { x: 0, y: -8 },
        radius: 10,
        visible: true,
        blendMode: 'NORMAL',
  ...
  if (buttonStyle === 'comicLight') {
    ...
    button.effects = [
      {
        type: 'DROP_SHADOW',
        color: { ...primaryColorAsRgbUnit, a: 1 },
        offset: { x: -4, y: 4 },
        radius: 0,
        visible: true,
        blendMode: 'NORMAL',
